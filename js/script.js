...
function speechQuestion(qNo,navQus){
    ...
    var l = 1;
    var qwords = "";
    var words = "repeat question | repeat options | option 1 | option one | option b | option c | option d | next question";
    while(l <= count){
    ...
    recognition.onresult = function(event) {
        ...
        if(l > count){
            ...
            else if(speechResult == "option 5" || speechResult == "option five" || speechResult == "option for") {
                flag = 1;
